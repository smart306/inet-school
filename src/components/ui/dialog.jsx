...
function DialogHeader({
  ...
  return (
    <div
      ...
      className={cn("hidden flex flex-col gap-2 text-center sm:text-left", className)}
      {...props} />
  );
}
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn("hidden flex flex-col-reverse gap-2 sm:flex-row sm:justify-end", className)}
      {...props} />
  );
}
